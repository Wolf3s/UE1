...
extern NSDLDRV_API UBOOL GPS2TickDue;

//
// A SDL2 viewport.
//
class NSDLDRV_API UPS2GsKitViewport : public UViewport
{
	DECLARE_CLASS_WITHOUT_CONSTRUCT( UPS2GsKitViewport, UViewport, CLASS_Transient )
	NO_DEFAULT_CONSTRUCTOR( UPS2GsKitViewport )

	// Constructors.
	UPS2GsKitViewport( ULevel* InLevel, class UPS2GsKitClient* InClient );
...
private:
	...
	// Variables.
	class UPS2GsKitClient* Client;
	SDL_Window* hWnd;
	GSGLOBAL *GSGlob; // for accelerated SoftDrv
	GSTEXTURE *GSTex; // for use with the above renderer
	DWORD GSTexFormat;
	UBOOL Destroyed;
	INT DisplayIndex;
...
//
class NSDLDRV_API UPS2GsKitClient : public UClient, public FNotifyHook
{
	DECLARE_CLASS_WITHOUT_CONSTRUCT( UPS2GsKitClient, UClient, CLASS_Transient|CLASS_Config )
